...
jobs:
  build:
    ...
    - name: Start application with timeout
      run: |
        timeout 14520s npm run muzan-md
...
## Développeurs :
- [**muzantech**](https://whatsapp.com/channel/0029VasZwtl6LwHqW3olOH44)
- [**jarixpro᚜**](https://github.com/muzantech/Muzan-Md)
